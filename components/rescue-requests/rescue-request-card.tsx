...
import { MapPin, LifeBuoy, Clock } from 'lucide-react';
...
const RescueRequestCard = ({ request, onClick }: RescueRequestCardProps) => {
  const [imgError, setImgError] = React.useState(false);

  const displayTitle =
    request.address && request.address.trim().length > 0
      ? request.address
      : `Rescue #${request.id.slice(0, 8)}`;
          ...
          <div className="card__left">
            <div className="card__header">
              ...
              <p className="card__description">
                {request.people_count} {request.people_count === 1 ? 'person' : 'people'} • {request.urgency_level}
              </p>
            </div>
            ...
            <div className="card__info">
              ...
              <div className="info-item">
                ...
                <span className="truncate">{getDaysAgo(request.created_at)}</span>
              </div>
            </div>
