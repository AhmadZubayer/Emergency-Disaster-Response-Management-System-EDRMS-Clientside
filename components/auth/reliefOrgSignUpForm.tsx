      ...
      <Card className="w-full max-w-xl text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground max-w-md mx-auto leading-relaxed">
            Thank you for applying to register <span className="font-medium text-foreground">{orgName}</span> as an official Relief Organization. Our administrative team will review your verification credentials and notify you once approved.
          </p>
        </div>
      ...
      <CardContent className="space-y-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4.5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="regNumber" className="flex items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <Label htmlFor="orgType" className="flex items-center">
              ...
              {errors.organization_type && (
                <p className="text-xs text-destructive">{errors.organization_type}</p>
              )}
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative border-2 border-dashed border-border hover:border-primary/50 transition-colors rounded-lg p-4 bg-muted/20 text-center">
              <input
                type="file"
                multiple
            ...
            {errors.verification_docs && (
              <p className="text-xs text-destructive">{errors.verification_docs}</p>
            )}
            ...
            {selectedFiles.length > 0 && (
              <div className="space-y-1.5 pt-1">
                {selectedFiles.map((file, idx) => (
                  <div
                    key={`${file.name}-${idx}`}
                    className="flex items-center justify-between px-3 py-2 bg-muted/40 border border-border rounded-lg text-xs"
                  >
