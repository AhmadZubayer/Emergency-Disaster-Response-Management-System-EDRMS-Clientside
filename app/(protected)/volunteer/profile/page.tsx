...
const VolunteerProfilePage = () => {
  ...
  const handleVerification = async () => {
    ...
    try {
      ...
      await axiosSecure.post(
        ENDPOINTS.VOLUNTEERS.APPLY_VERIFICATION,
        formData,
        {
  ...
  return (
    <>
      ...
      >
        {profileError ? (
          <LoadError message={profileError} retry={fetchPageData} />
        ) : !volunteerProfile ? (
          <div className="rounded-lg border border-border bg-card p-5 space-y-5">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Add your skills and motivation, then submit your identity
                document for verification.
              </p>
            </div>
            <VolunteerProfileForm onSuccess={fetchPageData} />
          </div>
        ) : (
          <div className="space-y-6">
                ...
                <div className="space-y-1">
                  ...
                  <div>
                    {volunteerProfile?.available ? (
                      <Badge variant="outline">Available for Deployment</Badge>
                    ) : (
                  ...
                  <div className="flex flex-wrap gap-1.5 pt-1">
                    {volunteerProfile?.skills?.length ? (
                      ...
                      <span className="text-muted-foreground italic">
                        No specialized skills selected.
                      </span>
                    )}
                  </div>
                </div>
            ...
            <div className="rounded-lg border border-border bg-card p-4 space-y-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Upload your National ID or government passport to receive
                  official volunteer verification badge.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 pt-2">
                ...
                <Button
                  ...
                  disabled={
                    ...
                    (!verificationFile && !volunteerProfile?.nid_card_url)
                  }
                  size="sm"
                  className="shrink-0"
                >
